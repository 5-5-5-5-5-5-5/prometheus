...
export const CliProcessamentoDiagnosticoMessages = {
  ...
  novosArquivosRaiz: (joined: string) => `New files in root: ${joined}`,
  ...
  relatorioFullFragmentado: (manifestFile: string | undefined) => `Fragmented full report. Manifest: ${manifestFile}`,
